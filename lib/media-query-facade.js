...
Emitter.prototype.on = function(query, callback, context){
  var queryObject = this._getQueryObject(query) || this._createQueryObject(query);
...
Emitter.prototype.off = function(query, callback, context){
  ...
  if (!callback && !context) return this._removeQueryObject(this.aliases[query] || query);
...
Emitter.prototype._removeHandler = function(query, callback, context){
  var handlers = this._getQueryObject(query).handlers;
